...
export default function FormEmbed({ formUrl, formPayload }: Props) {
  ...
  async function handleContinue() {
    ...
    try {
      const { editorUrl } = await createQuizAnon(formPayload)
      const url = new URL(editorUrl)
      url.searchParams.set('utm_source', 'generator')
      url.searchParams.set('utm_medium', 'shadow-form')
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Take control of this form for free
          </h3>
          ...
          >
            ...
            >
              ...
              {busy ? 'Creating...' : 'Continue editing'}
            </span>
          </button>
        </div>
